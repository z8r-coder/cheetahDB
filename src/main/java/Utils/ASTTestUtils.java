...
//        ASTTestPrint(ast.getRoot_set().get(0));
        ...
        //单行非缺省值通过测试
//        AST ast = SQLParserProxy.AssSQlASTgen("INSERT INTO Persons (LastName, Address) VALUES ('Wilson', 'Champs-Elysees');");
//        ASTTestPrint(ast.getRoot_set().get(0));

        //多行插入缺省值
        AST ast = SQLParserProxy.AssSQlASTgen("insert into persons" +
